...
{
    // 内存存储的配置数据（实际项目中应使用数据库或配置文件）
    private static readonly List<string> EquipmentModels = new()
    {
        "Francis", "Pelton", "Kaplan", "Nuclear Steam Turbine", "CAP1400",
        "HTR Steam Turbine", "AP1000", "Pump-Turbine", "Rotary"
    };

    private static readonly List<string> CapacityLevels = new()
    {
        "50MW", "100MW", "170MW", "200MW", "300MW", "400MW", "500MW",
        "550MW", "600MW", "700MW", "770MW", "800MW", "850MW", "1000MW",
        "1100MW", "1200MW", "1400MW"
    };
    ...
    private static readonly Dictionary<string, List<string>> TaskCategories = new()
    {
        ...
        ["PRODUCT_DEV"] = new List<string> { "技术方案", "设计流程", "方案评审", "专利申请", "出图", "图纸改版", "设计总结" },
    ...
    public Task<SettingsApiResponse<object>> AddEquipmentModelAsync(AddEquipmentModelRequest request)
    {
        ...
        {
            return Task.FromResult(new SettingsApiResponse<object> { Success = false, Error = "机型已存在" });
        }
        EquipmentModels.Add(request.Model);
        return Task.FromResult(new SettingsApiResponse<object> { Success = true, Message = "添加成功" });
    }
    ...
    public Task<SettingsApiResponse<object>> DeleteEquipmentModelAsync(string model)
    {
        ...
        {
            return Task.FromResult(new SettingsApiResponse<object> { Success = false, Error = "机型不存在" });
        }
        return Task.FromResult(new SettingsApiResponse<object> { Success = true, Message = "删除成功" });
    }
    ...
    public Task<SettingsApiResponse<object>> BatchAddEquipmentModelsAsync(BatchAddEquipmentModelsRequest request)
    {
        ...
        return Task.FromResult(new SettingsApiResponse<object> { Success = true, Message = $"成功添加 {request.Models.Count} 个机型" });
    }
    ...
    public Task<SettingsApiResponse<object>> AddCapacityLevelAsync(AddCapacityLevelRequest request)
    {
        ...
        {
            return Task.FromResult(new SettingsApiResponse<object> { Success = false, Error = "容量等级已存在" });
        }
    ...
    public Task<SettingsApiResponse<object>> DeleteCapacityLevelAsync(string level)
    {
        ...
        {
            return Task.FromResult(new SettingsApiResponse<object> { Success = false, Error = "容量等级不存在" });
        }
        return Task.FromResult(new SettingsApiResponse<object> { Success = true, Message = "删除成功" });
    }
    ...
    public Task<SettingsApiResponse<object>> AddTravelLabelAsync(AddTravelLabelRequest request)
    {
        ...
        {
            return Task.FromResult(new SettingsApiResponse<object> { Success = false, Error = "标签已存在" });
        }
    ...
    public Task<SettingsApiResponse<object>> DeleteTravelLabelAsync(string label)
    {
        ...
        {
            return Task.FromResult(new SettingsApiResponse<object> { Success = false, Error = "标签不存在" });
        }
        return Task.FromResult(new SettingsApiResponse<object> { Success = true, Message = "删除成功" });
    }
    ...
    public Task<UserAvatarResponse?> GetUserAvatarAsync(string userId)
    {
        ...
        {
            return Task.FromResult<UserAvatarResponse?>(new UserAvatarResponse { UserId = userId, Avatar = avatar });
        }
    ...
    public Task<SettingsApiResponse<object>> SaveUserAvatarAsync(string userId, SaveUserAvatarRequest request)
    {
        ...
        return Task.FromResult(new SettingsApiResponse<object> { Success = true, Message = "头像保存成功" });
    }
    ...
    public Task<SettingsApiResponse<object>> DeleteUserAvatarAsync(string userId)
    {
        ...
        {
            return Task.FromResult(new SettingsApiResponse<object> { Success = true, Message = "头像删除成功" });
        }
        return Task.FromResult(new SettingsApiResponse<object> { Success = false, Error = "头像不存在" });
    }
    ...
    public Task<SettingsApiResponse<object>> UpdateTaskCategoriesAsync(string code, UpdateTaskCategoriesRequest request)
    {
        if (TaskCategories.ContainsKey(code))
        {
            ...
            return Task.FromResult(new SettingsApiResponse<object> { Success = true, Message = "更新成功" });
        }
        return Task.FromResult(new SettingsApiResponse<object> { Success = false, Error = "任务类别不存在" });
    }
    ...
    {
        // 实际项目中需要重置数据库
        return Task.FromResult(new SettingsApiResponse<object> { Success = true, Message = "数据重置成功" });
    }

    public Task<SettingsApiResponse<object>> RefreshTasksAsync()
    {
        return Task.FromResult(new SettingsApiResponse<object> { Success = true, Message = "任务数据已刷新" });
    }

    public Task<SettingsApiResponse<object>> MigrateDataAsync()
    {
        return Task.FromResult(new SettingsApiResponse<object> { Success = true, Message = "数据迁移完成", Data = 0 });
    }
